...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="mb-6">
            ...
            <div
                class="bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl shadow-lg border border-orange-300 p-6">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        <div class="flex items-center gap-3 mb-2">
                            <span
                                class="bg-white text-orange-600 px-3 py-1 rounded-full text-xs font-bold flex items-center">
                    ...
                    <div class="flex gap-3">
                        <div
                            class="bg-white bg-opacity-20 backdrop-blur rounded-lg px-5 py-3 text-center border border-white border-opacity-30">
                        ...
                        <div
                            class="bg-white bg-opacity-20 backdrop-blur rounded-lg px-5 py-3 text-center border border-white border-opacity-30">
                            <div class="text-2xl font-bold text-black">₱<?php echo number_format($totalValue, 2); ?>
                            </div>
        ...
        <?php if (isset($_SESSION['error_message'])): ?>
            <div
                class="bg-red-50 border-l-4 border-red-500 text-red-700 px-5 py-4 rounded-lg mb-6 flex items-start animate-slideIn">
                <i class="fas fa-exclamation-circle mr-3 mt-0.5 text-lg"></i>
                <div>
                    <p class="font-semibold">Error</p>
                    <p class="text-sm"><?php echo $_SESSION['error_message'];
                    ...
                    <div class="space-y-5">
                        ...
                        <?php if ($isPickup): ?>
                            ...
                            <div>
                                ...
                                <div class="bg-gray-50 border border-gray-300 rounded-lg p-3">
                                    <p class="font-semibold text-gray-900">
                                        <?php echo htmlspecialchars($schedule['customer_name']); ?></p>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="courier_name" value="Customer Pickup - Replacement" readonly
                        ...
                        <?php else: ?>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="courier_name" required value="Replacement Delivery"
                                        class="w-full pl-11 pr-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all"
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">
                                ...
                                Estimated <?php echo $isPickup ? 'Pickup' : 'Delivery'; ?> Time <span
                        ...
                        <div>
                            ...
                            <textarea name="booking_notes" rows="4"
    ...
    <div id="detailsModal"
        ...
        <div class="bg-white rounded-xl shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-y-auto">
            <div
                class="sticky top-0 bg-gradient-to-r from-orange-600 to-orange-700 p-6 rounded-t-xl z-10 flex items-center justify-between">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-orange-50 border-2 border-orange-200 rounded-lg p-5">
                            <h4
                                class="font-bold text-orange-900 mb-4 pb-3 border-b border-orange-200 flex items-center justify-between">
                            ...
                            <div class="space-y-3 text-sm">
                                ...
                                <div>
                                    ...
                                    <p class="font-bold text-orange-900"><?php echo count($replacements); ?> products
                                    </p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p class="font-bold text-orange-900 text-lg">
                                        ₱<?php echo number_format($totalValue, 2); ?></p>
                                </div>
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        foreach ($reasons as $reason => $count):
                                            ...
                                            <div class="flex items-center justify-between text-xs">
                                                <span
                                                    class="text-orange-900 capitalize"><?php echo htmlspecialchars(str_replace('_', ' ', $reason)); ?></span>
                                                <span
                                                    class="bg-orange-100 text-orange-800 px-2 py-0.5 rounded-full font-bold"><?php echo $count; ?></span>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
                        ...
                        <div
                            class="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-200 rounded-lg p-5">
                            <h4
                                class="font-bold text-purple-900 mb-4 pb-3 border-b border-purple-200 flex items-center">
                                <i class="fas fa-box text-purple-600 mr-2"></i>
                                Shipment Specifications
                                <span
                                    class="ml-2 text-xs bg-purple-200 text-purple-800 px-2 py-1 rounded-full">Replacement</span>
                            </h4>
                        ...
                        <div class="bg-green-50 border-2 border-green-200 rounded-lg p-5">
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between items-center text-sm">
                                    ...
                                    <span
                                        class="font-bold <?php echo $isPickup ? 'bg-indigo-100 text-indigo-800' : 'bg-blue-100 text-blue-800'; ?> px-3 py-1 rounded-full">
                                        <i
                                            class="fas <?php echo $isPickup ? 'fa-hand-holding' : 'fa-truck'; ?> mr-1"></i>
                    ...
                    <div>
                        <div class="bg-gray-50 border-2 border-gray-200 rounded-lg p-5 h-full">
                            <h4
                                class="font-bold text-gray-900 mb-4 pb-3 border-b border-gray-300 flex items-center justify-between">
                                <span class="flex items-center">
                                    <i class="fas fa-box-open text-gray-600 mr-2"></i>
                                    Replacement Items
                                </span>
                                <span class="bg-orange-100 text-orange-800 text-xs font-bold px-3 py-1 rounded-full">
                                    <?php echo count($replacements); ?> Products | Total Qty:
                                    ...
                                    <div class="bg-white rounded-lg p-5 border-2 border-orange-200">
                                        <div class="flex items-start justify-between mb-3">
                                            <h5 class="font-bold text-gray-900 text-base leading-tight flex-1">
                                                <span
                                                    class="bg-orange-100 text-orange-800 px-2 py-1 rounded text-xs font-bold mr-2">
                                                    #<?php echo $index + 1; ?>
                                                </span>
                                                <?php echo htmlspecialchars($replacement['product_name']); ?>
                                            </h5>
                                            <span
                                                class="bg-orange-100 text-orange-800 text-xs font-bold px-3 py-1 rounded-full whitespace-nowrap ml-2">
                                            ...
                                            <div class="space-y-1 mb-3 text-sm">
                                                <?php if ($replacement['variant_color']): ?>
                                                    <div class="flex items-center text-gray-600">
                                                        ...
                                                        <span
                                                            class="ml-2"><?php echo htmlspecialchars($replacement['variant_color']); ?></span>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if ($replacement['size']): ?>
                                                    <div class="flex items-center text-gray-600">
                                                        ...
                                                        <span
                                                            class="ml-2"><?php echo htmlspecialchars($replacement['size']); ?></span>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <div class="bg-orange-50 border border-orange-200 rounded p-3 mb-3">
                                            <div class="space-y-2 text-xs">
                                                <div>
                                                    ...
                                                    <span
                                                        class="text-orange-900 font-bold ml-2">#<?php echo $replacement['id']; ?></span>
                                                </div>
                                                <div>
                                                    <span class="text-orange-700 font-semibold">Reason:</span>
                                                    <span
                                                        class="text-orange-900 ml-2 capitalize"><?php echo htmlspecialchars(str_replace('_', ' ', $replacement['reason'])); ?></span>
                                                </div>
                                                <?php if ($replacement['details']): ?>
                                                    <div>
                                                        <span class="text-orange-700 font-semibold">Details:</span>
                                                        <p class="text-orange-900 mt-1 text-xs">
                                                            <?php echo nl2br(htmlspecialchars($replacement['details'])); ?></p>
                                                    </div>
                                                <?php endif; ?>
                                                <div>
                                                    <span class="text-orange-700 font-semibold">Status:</span>
                                                    <span
                                                        class="inline-block bg-orange-100 text-orange-800 px-2 py-0.5 rounded-full text-xs font-bold ml-2">
                                        ...
                                        <div class="pt-3 border-t-2 border-gray-200">
                                            <div class="flex justify-between items-center text-sm mb-2">
                                                ...
                                                <span
                                                    class="font-bold text-gray-900">₱<?php echo number_format($replacement['price'], 2); ?></span>
                                            </div>
                                            <div class="flex justify-between items-center text-sm mb-2">
                                                <span class="text-gray-600">Quantity</span>
                                                <span
                                                    class="font-bold text-gray-900"><?php echo $replacement['replacement_quantity']; ?>
                                                    pcs</span>
                                            </div>
                            ...
                            <div class="mt-4 bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg p-4 text-white">
                                <div class="flex justify-between items-center">
                                    <div>
                                        ...
                                        <p class="text-sm"><?php echo count($replacements); ?> items •
                                            <?php echo $totalQuantity; ?> pieces</p>
                                    </div>
