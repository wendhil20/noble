...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    function createPayPalOrder($amount, $order_id, $config)
    {
        ...
        $order_data = [
            ...
            'application_context' => [
                'return_url' => 'http://localhost/noble/user/otherpage/checkout-paymongo-success-page-12-A.php',
                'cancel_url' => 'http://localhost/noble/user/otherpage/index-checkout-page-12.php',
    ...
    $paymongo_config = [
        ...
        'currency' => 'PHP',
        'success_url' => 'http://localhost/noble/user/otherpage/checkout-paymongo-success-page-12-A.php',
        'cancel_url' => 'http://localhost/noble/user/otherpage/index-checkout-page-12.php'
    ];
