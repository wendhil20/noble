...
try {
    ...
    $rescheduledBy = $_SESSION['noble_user'];
    $rescheduledOn = date('Y-m-d H:i:s');
    $notePrefix = "\n[Rescheduled on $rescheduledOn by $rescheduledBy]: ";
    $fullNote = $notePrefix . $reschedule_reason;
    ...
    $stmt->bind_param("sssi", $new_delivery_date, $new_delivery_time, $fullNote, $delivery_id);
