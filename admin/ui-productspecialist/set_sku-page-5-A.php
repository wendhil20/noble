...
<body class="bg-gray-100 min-h-screen font-sans">
    ...
    <div class="py-10 px-4 max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-6">
            ...
            <p class="text-gray-600">Product ID: <?= $product['id'] ?> | Codename:
                <?= htmlspecialchars($product['codename'] ?? 'N/A') ?></p>
        </div>
            ...
            <?php while ($variant = $variants->fetch_assoc()): ?>
                <div class="bg-white rounded-xl shadow p-6">
                                ...
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    <?php if (count($sku_data) === 1 && isset($sku_data['notes'])): ?>
                                        ...
                                        <div class="text-sm text-gray-800 whitespace-pre-wrap">
                                            <?= htmlspecialchars($sku_data['notes']) ?></div>
                                    <?php else: ?>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                            <?php foreach ($sku_data as $key => $value): ?>
                                                <div class="flex">
                                                    <span
                                                        class="font-semibold text-gray-700 min-w-[120px]"><?= htmlspecialchars(ucfirst(str_replace('_', ' ', $key))) ?>:</span>
                    ...
                    <form id="edit-<?= $variant['id'] ?>" method="POST" class="hidden">
                        ...
                        <textarea name="sku_data" rows="10"
    ...
    Any additional information here...</pre>
                        ...
                        <div class="flex gap-3 mt-4">
                            ...
                            <button type="button" onclick="toggleEdit(<?= $variant['id'] ?>)"
