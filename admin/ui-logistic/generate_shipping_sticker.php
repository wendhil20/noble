...
<body class="min-h-screen">
    ...
    <div class="no-print sticky top-0 z-25 bg-white border border-gray-100 shadow-sm">
        <div class="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between flex-wrap gap-3">
            <div class="flex items-center gap-3">
                <a href="<?= BASE_URL; ?>/logisticdispatcherviewbooking?booking_id=<?php echo $booking_id; ?>"
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="<?= BASE_URL; ?>/downloadstickerpdf?booking_id=<?php echo $booking_id; ?>"
            ...
            <div class="sticker-header-bar">
                <div class="flex items-center gap-3">
                    <div class="bg-white rounded-md p-1.5">
                        <img src="<?= BASE_URL; ?>/img/logo/logo.png" alt="home" class="w-12 h-12 object-contain" />
                    </div>
                    <div>
    ...
    <script>
        ...
        async function savePrintTimestamp() {
            try {
                const response = await fetch('<?= BASE_URL; ?>/logstickerprint', {
                    method: 'POST',
