...
if (isset($_FILES['csv_file'])) {
    try {
        ...
        $header = fgetcsv($file);
        $expectedHeaders = [
            'product_name', 'codename', 'quantity', 'description', 'type_name',
            'color_name', 'color_code', 'color_price', 'variant_size', 
            'variant_price', 'variant_namevariant', 'variant_percent', 
            'variant_discount', 'variant_color'
        ];
