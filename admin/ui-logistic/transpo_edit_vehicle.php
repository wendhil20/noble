...
if ($vehicle_id <= 0) {
    ...
    header("Location: " . BASE_URL . "/transpoaddvehicle");
    exit();
}
    ...
    <div class="container mx-auto px-4 py-6">
        <div class="bg-white shadow-md rounded-lg p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="transpoaddvehicle" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600 transition text-sm">
                    ← Back to List
                </a>
            </div>
