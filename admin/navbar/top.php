...
<body class="bg-gray-50" x-data="{ 
    ...
    <nav class="bg-white shadow-xl sticky top-0 z-30 border-b border-gray-200">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-1">
                    ...
                    <?php if (hasAnyRole(['superadmin', 'productspecialist'])): ?>
                        <div class="relative">
                            <button @click="activeDropdown = activeDropdown === 'products' ? null : 'products'"
                                class="desktop-nav-item nav-item px-4 py-2 rounded-lg font-medium transition-all duration-300 text-gray-700 hover:text-orange-500 hover:bg-gray-50 flex items-center space-x-2">
                            ...
                            <div x-show="activeDropdown === 'products'"
                                ...
                                x-cloak
                                class="absolute z-50 mt-2 w-80 dropdown-menu shadow-xl rounded-xl overflow-hidden right-0 bg-white">
                                <div class="p-6">
        ...
        <!-- Quick Action Bar -->
        <div class="bg-gradient-to-r from-orange-50 to-red-50 border-t border-orange-100 py-3">
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    <div class="relative w-full md:w-auto">
                        <button @click="quickActionsOpen = !quickActionsOpen"
                            class="inline-flex items-center space-x-2 px-4 py-2.5 bg-white rounded-xl text-sm font-medium text-gray-700 hover:text-orange-600 hover:bg-orange-50 transition-all duration-200 shadow-sm border border-orange-200">
...
<?php endif; ?>
                    ...
                    <!-- Right: User Info -->
                    <div class="hidden md:flex items-center space-x-3 bg-white px-4 py-2 rounded-xl shadow-sm border border-orange-200">
                        ...
                        <?php if (isset($_SESSION['noble_lvl'])): ?>
                            <span class="text-xs px-2 py-1 bg-orange-100 text-orange-600 rounded-full font-medium"><?= htmlspecialchars($_SESSION['noble_lvl']) ?></span>
                        <?php endif; ?>
