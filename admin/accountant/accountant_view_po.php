...
<body class="bg-gray-50">
            ...
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Order #<?php echo $order_id; ?> -
                            <?php echo htmlspecialchars($order['customer_name']); ?></p>
                    </div>
                </div>
                <div class="text-right">
                    <div class="bg-blue-50 px-4 py-2 rounded-lg mb-2">
                        <span class="text-blue-700 font-medium">Status:
                            <?php echo htmlspecialchars(ucfirst($order['status'])); ?></span>
                    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <p class="text-lg font-bold text-noble-orange">
                        ₱<?php echo number_format((float) $order['total'], 2); ?></p>
                </div>
                <div>
                            ...
                            <?php foreach ($items as $item): ?>
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-sm font-medium text-gray-900">
                                        ₱<?php echo number_format((float) $item['price'], 2); ?></td>
                                    <td class="px-4 py-3 text-sm text-gray-900">
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center space-x-3 flex-1">
                                            ...
                                            <div class="flex-1">
                                                <h4 class="font-medium text-gray-900">
                                                    <?php echo htmlspecialchars($file['original_filename']); ?></h4>
                                                ...
                                                <?php if ($file['approval_status'] == 'pending' && $file['requested_by_name']): ?>
                                                    <p class="text-xs text-orange-600 mt-1">
                                                        ...
                                                        <?php if ($file['approval_requested_at']): ?>
                                                            on
                                                            <?php echo date('M j, Y g:i A', strtotime($file['approval_requested_at'])); ?>
                                                        <?php endif; ?>
                                                    </p>
                                                <?php endif; ?>
                                                <?php if ($file['superadmin_name']): ?>
                                                    <p class="text-xs text-green-600 mt-1">
                                                        ...
                                                        <?php echo htmlspecialchars($file['superadmin_name']); ?>
                                                        <?php if ($file['superadmin_approved_at']): ?>
                                                            on
                                                            <?php echo date('M j, Y g:i A', strtotime($file['superadmin_approved_at'])); ?>
                                                        <?php endif; ?>
                                                    </p>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <?php if (!empty($file['file_replaced']) && $file['file_replaced'] == 1): ?>
                                                <span
                                                    class="inline-flex items-center px-3 py-1 text-xs font-medium bg-purple-100 text-purple-800 rounded-full">
                                            ...
                                            <?php if ($file['all_items_received'] == 1 && $file['po_status'] == 'received'): ?>
                                                <span
                                                    class="inline-flex items-center px-3 py-1 text-xs font-medium bg-emerald-100 text-emerald-800 rounded-full border-2 border-emerald-300">
                                                    <i class="fas fa-check-double mr-1"></i>
                                                    Fully Received
                                                    (<?php echo date('M j, Y', strtotime($file['all_items_received_at'])); ?>)
                                                </span>
                                            <?php elseif ($file['all_items_received'] == 1): ?>
                                                <span
                                                    class="inline-flex items-center px-3 py-1 text-xs font-medium bg-green-100 text-green-800 rounded-full">
                                            ...
                                            <?php elseif ($file['marked_as_ordered'] == 1): ?>
                                                <?php if ($file['po_status'] == 'currently_receiving'): ?>
                                                    <span
                                                        ...
                                                        Currently Receiving
                                                        (<?php echo date('M j, Y', strtotime($file['currently_receiving_at'])); ?>)
                                                    </span>
                                                    <span
                                                        class="inline-flex items-center px-3 py-1 text-xs font-medium bg-purple-100 text-purple-800 rounded-full">
                                                        <i class="fas fa-inbox mr-1"></i>
                                                ...
                                                <?php elseif ($file['po_status'] == 'out_for_delivery'): ?>
                                                    <span
                                                        class="inline-flex items-center px-3 py-1 text-xs font-medium bg-orange-100 text-orange-800 rounded-full">
                                                        <i class="fas fa-truck mr-1"></i>
                                                        Out for Delivery
                                                        (<?php echo date('M j, Y', strtotime($file['out_for_delivery_at'])); ?>)
                                                    </span>
                                                <?php elseif ($file['po_status'] == 'supplier_confirmed'): ?>
                                                    <span
                                                        ...
                                                        <i class="fas fa-check-circle mr-1"></i>
                                                        Supplier Confirmed
                                                        (<?php echo date('M j, Y', strtotime($file['supplier_confirmed_at'])); ?>)
                                                    </span>
                                                    <?php if ($file['expected_delivery_date']): ?>
                                                        <span
                                                            class="inline-flex items-center px-3 py-1 text-xs font-medium bg-yellow-100 text-yellow-800 rounded-full">
                                                            <i class="fas fa-calendar mr-1"></i>
                                            ...
                                            <?php if ($file['approval_status'] == 'pending'): ?>
                                                ...
                                                ?>
                                                <button type="button" data-file-id="<?php echo $fileId; ?>"
                                                    ...
                                                    data-upload-date="<?php echo $uploadDate; ?>" onclick="approveFileHandler(this)"
    ...
    <!-- Approve Modal -->
    <div id="approveModal"
        style="display:none; position:fixed; inset:0; z-index:50; background:rgba(0,0,0,0.5); overflow:auto;">
                        ...
                        <div class="bg-gray-50 rounded-lg p-4 mb-4 border border-gray-200">
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="flex-1 min-w-0">
                                 <!-- Approve Modal - file info card, palitan ang h4 ng filename -->
<h4 class="font-medium text-gray-900 mb-1 break-all truncate max-w-full" 
    id="approveFileNameDisplay"
    style="word-break: break-all; overflow-wrap: anywhere;"></h4>
    ...
    <div id="rejectModal"
                ...
                <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
                    <form method="POST">
                        <div class="p-6">
                            ...
                            <p class="text-gray-600 mb-4">Are you sure you want to reject <strong
                                    id="rejectFileName"></strong>?</p>
                            <input type="hidden" name="file_id" id="rejectFileId">
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Reason for rejection
                                    (optional)</label>
        ...
        <script>
            ...
            function approveFile(fileId, fileName, supplierName, fileSize, uploaderName, uploadDate) {
                ...
                document.getElementById('approveModal').style.display = 'block'; // ← block, hindi flex
            }
            ...
            function rejectFile(fileId, fileName) {
                ...
                document.getElementById('rejectModal').style.display = 'block'; // ← BUGFIX: dati 'hidden' ang sineset
            }
