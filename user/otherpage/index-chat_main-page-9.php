...
if (!isset($_SESSION['user_id'])) {
  header('Location: ' . BASE_URL . '/user/google-callback.php');
  exit;
}
...
<head>
  ...
  <style>
    ...
    #adminListContainer::-webkit-scrollbar {
      width: 4px;
    }
    ...
    /* Avatar palette */
    .av-a {
      background: linear-gradient(135deg, #0d1b2e, #1a2d45);
    }
