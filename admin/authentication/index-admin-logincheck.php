<?php
// index-admin-logincheck.php - Add this to the beginning of your login page (index.php)
    ...
    if ($result->num_rows === 1) {
        ...
        if ($user['status'] === 'active') {
            ...
            $redirect = match (strtolower($user['lvl'])) {
                ...
                'sales'                             => BASE_URL . "/admin/orders/generate_referral",
                'accountant'                        => match (strtolower($user['subrole'] ?? '')) {
                    'document_controller'           => BASE_URL . "/admin/accountant/accountant_view_orders",
                    default                        => BASE_URL . "/admin/accountant/accountant"
                },
                'supplier'                          => BASE_URL . "/admin/suppliermain/suppliercompany",
                'productspecialist'                 => BASE_URL . "/admin/shop/adminshop",
                'logistic'                          => BASE_URL . "/admin/logistic_management/logistics-main-dashboard-page-1",
                'warehouse'                         => match (strtolower($user['subrole'] ?? '')) {
                    'warehouse_receiver'            => BASE_URL . "/qrscanner",
                    'warehouse_staff'               => BASE_URL . "/ware",
                    default                         => BASE_URL . "/admin/warehouse_management/warehouse_head_dashboard_main"
                },
                'hr'                                => BASE_URL . "/admin/hr/account",
                default                             => BASE_URL . "/admin/client/dashboard"
            };
