                                    ...
                                    <tr class="hover:bg-blue-50 transition duration-200">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <img 
                                                    src="<?= BASE_URL; ?>/uploads/promotion_banners/<?php echo htmlspecialchars($promo['image']); ?>" 
                                                    alt="<?php echo htmlspecialchars($promo['title']); ?>"
                                                    class="h-16 w-24 rounded-lg object-cover shadow-md border border-gray-200"
                                                    onclick="openImageModal('<?= BASE_URL; ?>/uploads/promotion_banners/<?php echo htmlspecialchars($promo['image']); ?>', '<?php echo htmlspecialchars($promo['title']); ?>')"
                    ...
                    <div>
                        ...
                        <div class="mt-6">
                            ...
                            <div class="relative inline-block">
                                <img 
                                    id="currentImage"
                                    src="<?= BASE_URL; ?>/uploads/promotion_banners/<?php echo htmlspecialchars($promotion['image'] ?? ''); ?>" 
                                    alt="Current banner"
