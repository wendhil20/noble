...
<body class="bg-gray-50">
    <div class="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <?php if (!empty($message)): ?>
            <div class="alert mb-6 p-4 rounded-lg <?php echo $message_type === 'success' ? 'bg-green-100 border border-green-400 text-green-700' : 'bg-red-100 border border-red-400 text-red-700'; ?>">
