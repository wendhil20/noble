                ...
                <div class="hidden md:flex items-center space-x-1">
                    ...
                    <a href="../client/dashboard" 
                       class="nav-item px-4 py-2 rounded-lg font-medium transition-all duration-300 
                              <?= $current_page == 'dashboard' ? 'text-orange-600 bg-orange-50 active-link' : 'text-gray-700 hover:text-orange-500 hover:bg-gray-50' ?>">
                    ...
                    <a href="quote.php" 
                       class="nav-item px-4 py-2 rounded-lg font-medium transition-all duration-300 
                              <?= $current_page == 'quote.php' ? 'text-orange-600 bg-orange-50 active-link' : 'text-gray-700 hover:text-orange-500 hover:bg-gray-50' ?>">
                        <div class="flex items-center space-x-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="relative ml-4">
                        ...
                        <div x-show="activeDropdown === 'profile'" 
                            ...
                            <div class="p-2">
                                <a href="#" class="block px-4 py-3 text-gray-700 hover:text-orange-600 hover:bg-orange-50 rounded-lg transition-all duration-200">
                                    Settings
                                </a>
                                <a href="#" class="block px-4 py-3 text-gray-700 hover:text-orange-600 hover:bg-orange-50 rounded-lg transition-all duration-200">
                                    Profile
                                ...
                                <hr class="my-2">
                                <a href="#" class="block px-4 py-3 text-red-600 hover:bg-red-50 rounded-lg transition-all duration-200">
                                    Logout
                                </a>
                            </div>
                        </div>
