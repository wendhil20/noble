...
function showNotification(message, type = 'info') {
    ...
    notification.className = `fixed bottom-4 right-4 ${colors[type]} px-6 py-4 rounded-lg border shadow-lg z-50 max-w-md`;
    notification.innerHTML = `
        <div class="flex items-center gap-3">
            <div class="flex-1">${message}</div>
            <button onclick="this.parentElement.parentElement.remove()" class="text-black hover:text-white">
