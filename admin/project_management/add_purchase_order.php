<?php
// add_purchase_order_builder.php - Add Purchase Order with Quotation Builder
            ...
            <div class="p-6">
                ...
                <div class="mb-8">
                    ...
                    <div id="sizeOptions" class="grid grid-cols-2 gap-3">
                        ...
                        <!-- Example structure:
                    <button type="button" class="size-option-btn bg-white border-2 border-gray-300 hover:border-orange-400 hover:bg-orange-50 rounded-lg py-4 px-3 font-semibold text-gray-700 text-center transition-all duration-200 cursor-pointer text-sm line-clamp-2" data-size="1.5*2.0 & 228*165*104">
                        1.5*2.0 &<br>228*165*104
                    </button>
                    -->
                    </div>
                </div>
