                ...
                <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-green-600"><?= htmlspecialchars($delivery_settings['location_name']) ?>
                            </p>
                        </div>
                    </div>
            ...
            <div class="flex flex-col gap-4 sm:gap-6">
                <div class="flex items-center gap-3 sm:gap-4">
                    <div class="w-12 h-12 sm:w-16 sm:h-16 bg-primary/10 rounded-xl flex items-center justify-center">
                        <svg class="w-6 h-6 sm:w-8 sm:h-8 text-primary" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="flex items-center justify-between border-t pt-4">
                    <div>
                        <p class="text-2xl sm:text-3xl font-bold text-gray-900">
                            ₱<?= number_format($order['final_total'], 2) ?></p>
                    </div>
            ...
            <div class=" p-4 sm:p-6 mb-6 sm:mb-8 shadow-lg rounded-xl">
                    ...
                    <div class="bg-white rounded-lg p-4 sm:p-5">
                        <div class="text-center">
                            ...
                            <?php if ($booking_info['courier_name']): ?>
                                <div
                                    class="mt-3 inline-flex items-center gap-2 px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-sm font-semibold">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        if ($is_future && $days_until > 0):
                            ...
                            <div class="mt-4 text-center">
                                <div
                                    class="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 text-blue-800 rounded-full text-sm font-semibold">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <?php elseif ($has_scheduled_delivery): ?>
                    <div class="bg-white rounded-lg p-4 sm:p-5">
                        <div class="text-center">
                            ...
                            <div
                                class="mt-3 inline-flex items-center gap-2 px-3 py-1 bg-indigo-100 text-indigo-800 rounded-full text-sm font-semibold">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        if ($is_future && $days_until > 0):
                            ...
                            <div class="mt-4 text-center">
                                <div
                                    class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-100 text-indigo-800 rounded-full text-sm font-semibold">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                    ...
                    <div class="bg-white rounded-lg p-4 sm:p-5">
                        <div class="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3">
                            ...
                            <div class="block sm:hidden">
                                <svg class="w-4 h-4 text-blue-500 rotate-90" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                ...
                <div class="mt-3 flex items-start gap-2 text-xs sm:text-sm text-gray-600">
                    ...
                    <p>
                        ...
                        <?php else: ?>
                            This is an estimated timeframe based on supplier lead times. We'll update you once delivery is
                            scheduled.
                        <?php endif; ?>
                    </p>
                </div>
                ...
                foreach ($order_steps as $step_key => $step_data):
                    ...
                    ?>">
                        ...
                        <div class="text-center w-full">
                            <h4
                                class="text-sm font-semibold leading-tight <?= ($is_completed || $is_current) ? 'text-gray-900' : 'text-gray-400' ?>">
                                <?= $step_data['name'] ?>
                            </h4>
                            <p
                                class="text-xs <?= ($is_completed || $is_current) ? 'text-gray-600' : 'text-gray-400' ?> mt-1 leading-tight">
                                <?= $step_data['description'] ?>
                            </p>
                            <?php if ($is_current): ?>
                                <span
                                    class="inline-block mt-2 px-2 py-1 text-xs font-medium bg-primary text-white rounded-full">
                                    Current
                                </span>
                            <?php endif; ?>
                        </div>
                ...
                foreach ($order_steps as $step_key => $step_data):
                    ...
                    ?>">
                        ...
                        <div class="mobile-step-content">
                            <h4
                                class="text-sm font-semibold <?= ($is_completed || $is_current) ? 'text-gray-900' : 'text-gray-400' ?>">
                                <?= $step_data['name'] ?>
                            </h4>
                            ...
                            <?php if ($is_current): ?>
                                <span
                                    class="inline-block mt-1 px-2 py-1 text-xs font-medium bg-primary text-white rounded-full">
                                    Current
                                </span>
                            <?php endif; ?>
                        </div>
            ...
            <?php if ($show_feedback_button): ?>
                <div class="mt-6 border-t pt-6">
                    ...
                    <button onclick="openFeedbackModal()"
                        class="w-full bg-green-500 hover:from-green-600 hover:to-green-700 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="bg-green-50 border border-green-200 rounded-xl p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                <?php endfor; ?>
                                <span
                                    class="ml-2 text-sm font-semibold text-green-800"><?= $existing_feedback['rating'] ?>/5</span>
                            </div>
                        </div>
                        ...
                        <?php if ($existing_feedback['feedback_text']): ?>
                            <div class="border-t border-green-200 pt-3">
                                <p class="text-sm text-green-700 italic">
                                    "<?= htmlspecialchars($existing_feedback['feedback_text']) ?>"</p>
                            </div>
                        <?php endif; ?>
            ...
            <?php if (!$show_item_tracking): ?>
                <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-3 sm:p-4 mb-4 sm:mb-6">
                    <div class="flex items-center gap-3">
                        <div
                            class="w-8 h-8 sm:w-10 sm:h-10 bg-gray-100 rounded-lg flex items-center justify-center shrink-0">
                                ...
                                <div class="hidden sm:flex items-center justify-between">
                                    ...
                                    foreach ($replacement_steps as $step_key => $step_data):
                                        ...
                                        <div class="flex flex-col items-center flex-1">
                                            ...
                                            <p
                                                class="text-xs font-medium <?= $is_completed ? 'text-orange-800' : 'text-gray-500' ?> text-center leading-tight">
                                                <?= $step_data['name'] ?>
                                            </p>
                                        </div>
                                        ...
                                        <?php if (!$is_last): ?>
                                            <div
                                                class="flex-1 h-0.5 mx-2 <?= $is_completed && $step_count < $replacement_current_index ? 'bg-green-500' : 'bg-gray-300' ?>">
                                            </div>
                                        <?php endif; ?>
                                ...
                                <div class="sm:hidden mobile-item-steps">
                                    <div class="flex items-center space-x-3 pb-2" style="min-width: max-content;">
                                        ...
                                        foreach ($replacement_steps as $step_key => $step_data):
                                            ...
                                            <?php if (!$is_last): ?>
                                                <div
                                                    class="h-0.5 w-6 shrink-0 <?= $is_completed && $step_count < $replacement_current_index ? 'bg-green-500' : 'bg-gray-300' ?> mt-3">
                                                </div>
                                            <?php endif; ?>
                                ...
                                <div class="flex items-center space-x-4 pb-2" style="min-width: max-content;">
                                    ...
                                    foreach ($steps as $step_key => $step_data):
                                        ...
                                        <div class="flex flex-col items-center shrink-0 w-16">
                                            ...
                                            <div class="text-center">
                                                <p
                                                    class="text-xs font-medium <?= $is_completed ? 'text-gray-900' : 'text-gray-400' ?> leading-tight">
                                                    <?= $step_data['name'] ?>
                                                </p>
                                                <?php if ($is_current): ?>
                                        ...
                                        <?php if (!$is_last): ?>
                                            <div
                                                class="h-0.5 w-8 shrink-0 <?= $is_completed && $step_count < $current_step_index ? 'bg-success' : 'bg-gray-200' ?> mt-4">
                                            </div>
                                        <?php endif; ?>
            ...
            <div class="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 animate-slide-in">
                ...
                <div class="space-y-2 text-sm">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span
                            class="text-gray-900 font-medium">₱<?= number_format($order['delivery_fee'] ?? 0, 2) ?></span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-600">VAT:</span>
                        <span
                            class="text-gray-900 font-medium">₱<?= number_format($order['vat_amount'] ?? 0, 2) ?></span>
                    </div>
