...
<select name="category" required class="w-full border p-2 rounded bg-white">
  ...
  <script>
    ...
    function addColor() {
      ...
      div.innerHTML = `<input type="hidden" name="color_id[]" value="new" /><div class="flex items-center"><span class="text-sm text-gray-400 w-[50px]">New</span></div><input type="text" name="color_name[]" placeholder="Color Name" class="border p-2 w-1/6 rounded" required /><input type="text" name="color_code[]" placeholder="Color Code (#hex)" class="border p-2 w-1/6 rounded" /><div class="w-1/6"><input type="file" name="color_image[]" accept="image/*" class="w-full text-xs" required /><p class="text-xs text-gray-500 mt-1">Main Image</p></div><div class="w-1/6"><input type="file" name="color_image2[]" accept="image/*" class="w-full text-xs" /><p class="text-xs text-gray-500 mt-1">Secondary Image</p></div><input type="number" step="0.01" name="color_price[]" placeholder="Color Price" class="border p-2 w-1/6 rounded" required /><input type="number" name="color_stock[]" placeholder="Stock" value="0" class="border p-2 w-1/6 rounded" required /><button type="button" onclick="removeColor(this)" class="text-red-500 text-sm">✕</button>`;
