...
if ($order_id <= 0) {
    header("Location: " . BASE_URL . "/ownerdashboard");
    exit();
}
        ...
        <div class="max-w-[1400px] mx-auto px-6 py-5">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    <a href="<?= BASE_URL ?>/ownerdashboard" class="flex items-center justify-center w-10 h-10 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">
