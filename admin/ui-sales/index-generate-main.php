<?php
// generate_referral.php - Complete Referral Code System with Remake Featured
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['generate_code'])) {
    ...
    if ($referral_data !== null) {
        ...
        if (strpos($host, 'localhost') !== false || strpos($host, '127.0.0.1') !== false) {
            $base_url = "http://localhost/noble/";
        } else {
            $base_url = "https://noblehomedepot.com";
        }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['remake_code'])) {
    ...
    if ($referral_data === null) {
        ...
        if ($stmt->execute()) {
            ...
            // Redirect to reload the page with fresh data
            header("Location: " . BASE_URL . "/generatereferral");
            exit();
        } else {
        ...
        <?php if ($referral_data !== null): ?>
            ...
            <div class="bg-gray-100  overflow-hidden mb-6">
                ...
                <div class="p-2">
                    ...
                    <div class="mb-6">
                        <label class="block text-lg text-black mb-2">
...
");
        ...
        ");
                        ...
                        <div class="p-6">
                            ...
                            <?php if (!empty($referral_data['commission_breakdown'])): ?>
                                ...
                                <?php if (!empty($referral_data['claimed_history'])): ?>
                                    <div
                                        class="bg-gray-100 rounded-lg border-2 border-gray-300 overflow-hidden mt-6">
                                        <div
                                            class="bg-gray-600 px-4 py-3 flex items-center justify-between">
                    ...
                    <div class="bg-white  shadow-lg border border-gray-200 overflow-hidden mt-6">
                        <div class="bg-black px-4 sm:px-6 py-3 sm:py-4">
            ...
            <div class="p-8 sm:p-12 text-center">
                ...
                <form method="POST">
                    <button type="submit" name="generate_code"
                        class="inline-flex items-center space-x-2 bg-black hover:from-purple-600 hover:to-purple-700 text-white px-8 py-3 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg text-lg font-medium">
                        <i class="fas fa-magic"></i>
                ...
                <div class="grid grid-cols-3 gap-2 text-center">
                    ...
                    <div>
                        <div class="font-bold text-green-600">
                            <?php echo number_format($referral_data['conversions'] ?? 0); ?>
                        </div>
    ...
    <script>
        ...
        function showNotification(message, type) {
            ...
            document.querySelectorAll('.noble-notification').forEach(n => n.remove());

            const notification = document.createElement('div');
            notification.className = `noble-notification fixed bottom-6 left-6 ${colors[type] || colors.info} text-white px-3 py-2 rounded-lg shadow-2xl z-50 flex items-center gap-3 text-sm `;
    ...
    `;
        ...
        function saveQRCodeToDatabase(qrData) {
            fetch('<?= BASE_URL; ?>/savereferral', {
                ...
                .then(data => {
                    if (data.success) {
                        showNotification(' QR code generated and saved.', 'success');
