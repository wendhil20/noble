...
<body class="bg-gray-100 font-sans">
    ...
    <div class="bg-white p-6 rounded shadow mt-3 max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center flex-1">
                    <div class="w-10 h-10 bg-orange-600 text-white rounded-full flex items-center justify-center font-bold">1</div>
                    <div class="ml-3">
                        <div class="font-medium text-orange-600">Customer Info</div>
                ...
                <div class="flex items-center flex-1">
                    ...
                    <div class="ml-3">
                        <div class="font-medium text-gray-400">Delivery Address</div>
        ...
        <form method="POST" class="space-y-6">
            <div class="bg-orange-50 p-4 rounded-lg mb-6">
                <div class="flex items-center">
                    ...
                    <div>
                        <h3 class="text-lg text-orange-800">Step 1: Customer Information</h3>
                        <p class="text-orange-700 text-sm">Please verify your contact details</p>
                    </div>
                </div>
            </div>
...
<p class="text-xs text-gray-500 mt-1">Format: 9XXXXXXXXX (10 digits, without the leading 0)</p>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-blue-800">
                        <strong>Note:</strong> Make sure your contact information is correct. We'll use this to contact you about your order and delivery updates.
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-between items-center pt-4">
                ...
                <button type="submit" class="bg-orange-600 text-white px-8 py-3 rounded-lg hover:bg-orange-700 transition font-medium flex items-center">
                    Continue to Address
