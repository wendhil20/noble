...
<body>
    ...
    <div class="container mx-auto px-6 py-8 max-w-7xl">
       ...
       <div class="bg-white border-b border-gray-200">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mt-2">
    ...
    <script>
        ...
        function loadTiers(productId) {
            $.ajax({
                url: '<?= BASE_URL ?>/targetpricemanagementgettier',
                method: 'GET',
            ...
            if (dbId) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '<?= BASE_URL ?>/targetpricemanagementdelete',
                            method: 'POST',
                            data: { tier_id: dbId },
                            dataType: 'json',
                            success: function(response) {
        ...
        function saveTiers() {
            ...
            $.ajax({
                url: '<?= BASE_URL ?>/targetpricemanagementsave',
                method: 'POST',
                data: {
